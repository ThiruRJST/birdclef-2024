...
if __name__ == "__main__":
    ...
    train_paths, test_paths, train_labels, test_labels = train_test_split(data.filename.values, data.class_index.values, test_size=HyperParams.test_size, stratify=data.class_index.values)

    train_dataset = CLEFMelspec_v1(
        HyperParams.root_path,
        train_paths,
        train_labels
    )
